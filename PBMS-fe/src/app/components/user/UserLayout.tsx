...
export type UserScreen =
  "dashboard" | "monthly-cards" | "my-vehicles" | "regulations" | "support";
      ...
      <aside className="w-[210px] flex-shrink-0 bg-[#1a3560] flex flex-col overflow-hidden">
        <div className="flex items-center gap-2 px-4 py-4 border-b border-blue-900/60">
          ...
          <div className="flex flex-col">
            <span className="text-xs font-black tracking-wider text-white uppercase leading-none">
              Parking
            </span>
            <span className="text-[10px] text-sky-200 uppercase tracking-widest font-semibold mt-1">
              Member Portal
            </span>
          </div>
        </div>
        <div className="px-3 py-3 border-b border-blue-900/30 flex items-center gap-2.5">
          <div className="w-8 h-8 rounded-full bg-sky-500/20 text-sky-300 flex items-center justify-center font-bold text-sm border border-sky-400/30">
            {initials}
          </div>
