...
export default function UserReserveSlot() {
  ...
  const handleReserve = () => {
    ...
    if (!selectedSlot)
      return setError("Vui lòng chọn một slot trống trên bản đồ.");
    setConfirmed(true);
  };
          ...
          <div className="bg-white border border-green-200 rounded-lg p-8 max-w-md w-full text-center shadow-sm">
            ...
            <div className="bg-gray-50 rounded p-4 text-left text-sm space-y-1.5 mb-6">
              <div className="flex justify-between">
                <span className="text-gray-500">Thẻ tháng:</span>
              ...
              <div className="flex justify-between">
                <span className="text-gray-500">Giờ dự kiến:</span>
  ...
  return (
    <div className={cls.pageWrapper}>
      ...
      <div className="grid grid-cols-[380px_1fr] gap-3 flex-1 min-h-0">
        {/* Form */}
        <div
          className={`${cls.sectionCard} p-4 flex flex-col gap-3 overflow-y-auto`}
        >
          ...
          <div>
            <label className="block text-xs text-gray-600 mb-1">
              Thẻ tháng ô tô <span className="text-red-500">*</span>
            </label>
            <select
          ...
          <div>
            ...
            <input
              ...
              value={card?.plate ?? ""}
              readOnly
              placeholder="Chọn thẻ tháng để tự điền"
            />
          </div>

          <div>
            <label className="block text-xs text-gray-600 mb-1">
              Ngày đặt chỗ <span className="text-red-500">*</span>
            </label>
            <select
              className={`${cls.select} w-full`}
              value={date}
          ...
          <button
            ...
            className={`${cls.btnSearch} w-full justify-center mt-1`}
          >
          ...
          {!floor || !zone ? (
            ...
            <div>
              <p className="text-xs text-gray-500 mb-3">
                Tầng <strong>{floor}</strong> – Khu <strong>{zone}</strong> |
                Ngày: {date}
              </p>
