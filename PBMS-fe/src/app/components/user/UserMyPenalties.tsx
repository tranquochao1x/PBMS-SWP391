    ...
    <div className={cls.pageWrapper}>
      ...
      <div className={`${cls.filterSection} flex flex-wrap gap-2 items-end`}>
        ...
        <div>
          ...
          >
            <option value="">Tất cả</option>
            {(Object.keys(statusBadge) as PenaltyStatus[]).map((s) => (
          ...
          <div className="bg-white rounded-lg shadow-xl w-full max-w-md p-5">
            ...
            {appealDone ? (
              <div className="text-center py-4">
                ...
                <button
                  onClick={() => setAppealItem(null)}
                  className={`${cls.btnSearch} mt-4 mx-auto`}
                >
                  Đóng
                </button>
              </div>
              ...
              <>
                <div className="space-y-3 text-sm">
                  <div>
                    ...
                    <input
                      className={`${cls.input} w-full bg-gray-50`}
                      value={appealItem.id}
                      readOnly
                    />
                  </div>
                ...
                <div className="mt-4 flex justify-end gap-2">
                  ...
                  <button
                    onClick={() => appealNote.trim() && setAppealDone(true)}
