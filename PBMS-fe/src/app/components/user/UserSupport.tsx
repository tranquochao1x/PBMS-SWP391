...
const faqs = [
  {
    q: "Làm thế nào để gia hạn thẻ tháng?",
    a: "Vào mục 'Thẻ tháng của tôi', chọn thẻ cần gia hạn và nhấn nút 'Gia hạn'. Chọn số tháng và thanh toán qua QR.",
  },
  {
    q: "Tôi quên mật khẩu, phải làm gì?",
    a: "Vui lòng liên hệ với bộ phận hỗ trợ qua email hoặc số điện thoại bên dưới để được cấp lại mật khẩu.",
  },
  {
    q: "Biển số xe trên thẻ bị sai, cần cập nhật ở đâu?",
    a: "Vào mục 'Thẻ tháng của tôi', nhấn 'Xem chi tiết' trên thẻ cần cập nhật. Liên hệ nhân viên tại bãi xe để yêu cầu chỉnh sửa.",
  },
  {
    q: "Thẻ tháng hết hạn có còn vào được bãi không?",
    a: "Không. Thẻ hết hạn sẽ bị từ chối ở cổng vào. Vui lòng gia hạn trước ngày hết hạn để tránh gián đoạn.",
  },
  {
    q: "Tôi có thể đặt thẻ tháng cho ô tô không?",
    a: "Có. Khi thêm thẻ mới, chọn 'THÈ THÁNG Ô TÔ' và chọn 'Tầng gửi xe' (Tầng B1 hoặc B2) cho phù hợp.",
  },
];
    ...
    <div className="space-y-4 max-w-4xl mx-auto pb-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
        {[
          ...
          <div
            key={label}
            className={`border rounded-lg px-4 py-3 flex items-center gap-3 ${color}`}
          >
          ...
          <div className="bg-white rounded-lg shadow-xl w-full max-w-lg overflow-hidden border border-gray-150">
            ...
            <div className="p-4 space-y-3 text-sm max-h-[75vh] overflow-y-auto">
              ...
              <div className="grid grid-cols-3 gap-1 border-b border-gray-100 pb-2">
                ...
                <span className="col-span-2 text-gray-800">
                  {selectedRequest.assignedStaffName || "Chưa phân công"}
                </span>
              </div>
