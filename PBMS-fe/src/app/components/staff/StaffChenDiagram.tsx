...
function AL({
  ...
  return (
    <line x1={ax} y1={ay} x2={ex} y2={ey} stroke="#94a3b8" strokeWidth={1} />
  );
}
      ...
      <div className="bg-white border border-gray-200 rounded shadow-sm overflow-auto">
        ...
        >
          ...
          <CL
            ...
            y1={E.cgrp.cy + 24}
            x2={D.classifies.cx}
            y2={D.classifies.cy + 28}
          />
          <CL
            x1={D.classifies.cx}
            y1={D.classifies.cy - 28}
            x2={E.card.cx}
            y2={E.card.cy - 24}
          />
          ...
          <CL
            x1={E.card.cx + 70}
            y1={E.card.cy}
            x2={D.generates.cx - 62}
            y2={D.generates.cy}
          />
          <CL
            x1={D.generates.cx + 62}
            y1={D.generates.cy}
            x2={E.ticket.cx - 70}
            y2={E.ticket.cy}
          />
          ...
          <CL
            ...
            y1={E.lane.cy + 24}
            x2={D.processes.cx}
            y2={D.processes.cy + 28}
          />
          <CL
            x1={D.processes.cx}
            y1={D.processes.cy - 28}
            x2={E.ticket.cx}
            y2={E.ticket.cy - 24}
          />
          ...
          <CL
            x1={E.user.cx + 60}
            y1={E.user.cy + 18}
            x2={D.assignedTo.cx - 55}
            y2={D.assignedTo.cy - 10}
          />
          <CL
            x1={D.assignedTo.cx + 62}
            y1={D.assignedTo.cy}
            x2={E.sassign.cx - 70}
            y2={E.sassign.cy - 10}
          />
          ...
          <CL
            ...
            y1={E.lane.cy + 20}
            x2={D.hasAssign.cx - 5}
            y2={D.hasAssign.cy - 28}
          />
          <CL
            x1={D.hasAssign.cx - 5}
            y1={D.hasAssign.cy + 28}
            x2={E.sassign.cx + 50}
            y2={E.sassign.cy - 20}
          />
          ...
          <CL
            ...
            y1={E.card.cy + 24}
            x2={D.hasHistory.cx}
            y2={D.hasHistory.cy - 28}
          />
          <CL
            x1={D.hasHistory.cx}
            y1={D.hasHistory.cy + 28}
            x2={E.chist.cx - 18}
            y2={E.chist.cy - 24}
          />
          ...
          {/* CLASSIFIES */}
          <CardN x={425} y={192} n="1" />
          <CardN x={425} y={272} n="N" />
          {/* OWNS */}
          <CardN x={207} y={550} n="1" />
          <CardN x={303} y={475} n="N" />
          {/* GENERATES */}
          <CardN x={498} y={352} n="1" />
          <CardN x={640} y={352} n="N" />
          {/* PROCESSES */}
          <CardN x={745} y={192} n="1" />
          <CardN x={745} y={272} n="N" />
          {/* HANDLES */}
          <CardN x={248} y={336} n="1" />
          <CardN x={494} y={318} n="N" />
          {/* ASSIGNED_TO */}
          <CardN x={248} y={430} n="1" />
          <CardN x={498} y={488} n="N" />
          {/* HAS_ASSIGNMENT */}
          <CardN x={788} y={370} n="1" />
          <CardN x={788} y={560} n="N" />
          {/* HAS_HISTORY */}
          <CardN x={370} y={430} n="1" />
          <CardN x={370} y={560} n="N" />
          {/* PROC_CARD */}
          <CardN x={165} y={396} n="1" />
          <CardN x={272} y={650} n="N" />
          {/* TRIGGERS */}
          <CardN x={796} y={180} n="1" />
          <CardN x={952} y={282} n="N" />
          {/* MONITORS */}
          <CardN x={248} y={318} n="1" />
          <CardN x={648} y={318} n="N" />
        </svg>
      </div>
        ...
        <div className="grid grid-cols-3 gap-1.5">
          {[
            ...
            >
              ...
              <span className="font-mono font-semibold text-amber-800 mr-0.5">
                {r}
              </span>
