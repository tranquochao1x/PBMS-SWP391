    ...
    <div className="space-y-3">
      ...
      <div className="bg-white border border-gray-200 rounded shadow-sm overflow-auto">
        ...
        >
          ...
          <path
            d="M 147 145 C 147 215 295 215 295 215"
            stroke="#dc2626"
            strokeWidth="1.5"
            fill="none"
            strokeDasharray="5 3"
          ...
          <path
            d="M 533 378 C 533 410 453 410 453 378"
            stroke="#16a34a"
            strokeWidth="1.5"
            fill="none"
            markerEnd="url(#ah)"
          ...
          <path
            d="M 308 465 C 260 465 260 370 308 370"
            stroke="#16a34a"
            strokeWidth="1.5"
            fill="none"
            markerEnd="url(#ah)"
          ...
          {/* Đã PC → Đã hủy */}
          <path
            d="M 339 640 C 339 680 360 705 360 705"
            stroke="#dc2626"
            strokeWidth="1.5"
            fill="none"
            strokeDasharray="5 3"
          ...
          {/* Đang trực → Đã hủy */}
          <path
            d="M 542 640 C 542 685 450 705 450 705"
            stroke="#dc2626"
            strokeWidth="1.5"
            fill="none"
            strokeDasharray="5 3"
      ...
      <div className="grid grid-cols-3 gap-2">
        {[
          ...
          <div
            key={sm.title}
            className="bg-white border border-gray-200 rounded shadow-sm p-3"
          >
            <div
              className="text-xs font-bold mb-2 pb-1.5 border-b border-gray-100"
