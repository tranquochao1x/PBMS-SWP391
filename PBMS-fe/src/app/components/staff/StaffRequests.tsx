...
export default function StaffRequests() {
  ...
  const filtered = data.filter((r) => {
    ...
    if (
      ...
      !r.user.toLowerCase().includes(keyword.toLowerCase()) &&
      !r.vehicle.includes(keyword)
    )
      return false;
    return true;
  });
  ...
  const startProcessing = (id: string) => {
    setData((prev) =>
      prev.map((r) =>
        r.id === id ? { ...r, status: "Processing" as ReqStatus } : r,
      ),
    );
  };
    ...
    setData((prev) =>
      prev.map((r) =>
        r.id === resolveItem.id
          ? {
              ...r,
              status: "Resolved" as ReqStatus,
              notes: [...r.notes, `[Giải quyết] ${resolveNote.trim()}`],
            }
          : r,
      ),
    );
                    ...
                    <div className="flex gap-1 flex-wrap">
                      ...
                      {r.status === "Pending" && (
                        <button
                          ...
                          className="h-6 px-2 bg-sky-50 hover:bg-sky-100 text-sky-700 text-xs rounded border border-sky-200 flex items-center gap-1"
                        >
                      ...
                      {r.status !== "Resolved" && (
                        <button
                          ...
                          className="h-6 px-2 bg-amber-50 hover:bg-amber-100 text-amber-700 text-xs rounded border border-amber-200 flex items-center gap-1"
                        >
          ...
          <div className="bg-white rounded-lg shadow-xl w-full max-w-md p-5">
            ...
            <div className="space-y-2 text-sm">
              {[
                ...
                ["Ưu tiên", viewItem.priority],
                ["Phân công lúc", viewItem.assignedAt],
              ].map(([k, v]) => (
                <div
                  key={k}
        ...
        <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50">
          <div className="bg-white rounded-lg shadow-xl w-full max-w-sm p-5">
            <div className="flex justify-between items-center mb-3">
              ...
              <button onClick={() => setNoteItem(null)}>
                <X className="w-5 h-5 text-gray-400" />
              </button>
            </div>
            <textarea
            ...
            <div className="flex justify-end gap-2 mt-4">
              ...
              <button
                ...
                className={`${cls.btnSearch} ${!noteText.trim() ? "opacity-50 cursor-not-allowed" : ""}`}
              >
                Lưu ghi chú
              </button>
            </div>
          ...
          <div className="bg-white rounded-lg shadow-xl w-full max-w-sm p-5">
            <div className="flex justify-between items-center mb-3">
              <h3 className="font-semibold">
                Đánh dấu hoàn tất – {resolveItem.id}
              </h3>
            ...
            <div className="flex justify-end gap-2 mt-4">
              ...
              <button
                ...
                className={`${cls.btnSearch} ${!resolveNote.trim() ? "opacity-50 cursor-not-allowed" : ""}`}
              >
