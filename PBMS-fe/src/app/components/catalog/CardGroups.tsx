...
export default function CardGroups() {
  ...
  const handleSave = async () => {
    ...
    const defaultDurationDays =
      ticketType === "SINGLE" ? 0 : ticketType === "DAY" ? 1 : 30;
    const reservationAllowed =
      ticketType === "MONTHLY" && vehicleType === "CAR";
  ...
  const columns: Column[] = [
    ...
    },
    {
      ...
      render: (v: string) => (
        <span className={v === "Xe máy" ? cls.badge.blue : cls.badge.amber}>
          {v}
        </span>
      ),
    },
    {
      ...
      label: "Loại vé",
      render: (v: string) => (
        <span className={v === "Vé tháng" ? cls.badge.green : cls.badge.gray}>
          {v}
        </span>
      ),
    },
    {
      ...
      label: "Giá tiền",
      render: (v: string) => (
        <span className="font-semibold text-blue-700">{v} VNĐ</span>
      ),
    },
            ...
            <div className="p-5 space-y-3">
              <div>
                ...
                <input
                  ...
                  value={form.tenNhom}
                  onChange={(e) =>
                    setForm((p) => ({ ...p, tenNhom: e.target.value }))
                  }
                />
              </div>
              <div className="grid grid-cols-2 gap-3">
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      setForm((p) => ({ ...p, loaiPhuongTien: e.target.value }))
                    }
                  >
                ...
                <div>
                  ...
                  <select
                    ...
                    value={form.loaiVe}
                    onChange={(e) =>
                      setForm((p) => ({ ...p, loaiVe: e.target.value }))
                    }
                  >
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  ...
                  <input
                    ...
                    value={form.giaTien}
                    onChange={(e) =>
                      setForm((p) => ({ ...p, giaTien: e.target.value }))
                    }
                  />
                </div>
                <div>
              ...
              <div className="flex items-center gap-3 mb-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500 mt-0.5">
                    Bạn có chắc chắn muốn xóa nhóm thẻ này không?
                  </p>
                </div>
              </div>
            </div>
