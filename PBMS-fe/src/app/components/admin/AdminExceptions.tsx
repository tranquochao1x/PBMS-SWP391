              ...
              {loading ? (
                ...
                filtered.map((r, i) => (
                  ...
                  >
                    ...
                    <td
                      className="px-2 py-1.5 text-sm border-r border-gray-200 text-gray-600 truncate max-w-[200px]"
                      title={r.description}
                    >
                      {r.description}
                    </td>
                    ...
                    <td className={cls.td}>
                      <div className="flex gap-1 flex-wrap">
                        <button
                          ...
                          className="h-6 px-2 bg-blue-50 hover:bg-blue-100 text-blue-700 text-xs rounded border border-blue-200 flex items-center gap-1 cursor-pointer"
                        >
                        ...
                        {(r.status === "PENDING" ||
                          ...
                          <button
                            ...
                            className="h-6 px-2 bg-green-50 hover:bg-green-100 text-green-700 text-xs rounded border border-green-200 flex items-center gap-1 cursor-pointer"
                          >
                        ...
                        {r.status !== "RESOLVED" &&
                          ...
                          r.status !== "REJECTED" && (
                            <button
                              ...
                              className="h-6 px-2 bg-red-50 hover:bg-red-100 text-red-700 text-xs rounded border border-red-200 flex items-center gap-1 cursor-pointer"
                            >
            ...
            <div className="space-y-2 text-sm max-h-[60vh] overflow-y-auto pr-1">
              ...
              <div className="flex justify-between border-b border-gray-100 pb-1">
                ...
                <span className="font-medium">
                  {viewItem.senderRole === "STAFF" ? "Nhân viên" : "Người dùng"}
                </span>
              </div>
              <div className="flex justify-between border-b border-gray-100 pb-1">
