...
const SAMPLE: AuditLog[] = [
  {
    id: "LOG-001",
    eventType: "Slot Override",
    performedBy: "staff01",
    time: "2026-06-13 08:20",
    vehicle: "51A-12345",
    oldSlot: "B1-A01",
    newSlot: "B1-A03",
    reason: "Staff override khi vào",
    reservationId: "RES-001",
    requestId: "",
    detail: "Slot được staff ghi đè thủ công",
  },
  {
    id: "LOG-002",
    eventType: "Alternative Slot Proposed",
    performedBy: "staff02",
    time: "2026-06-13 08:45",
    vehicle: "51B-67890",
    oldSlot: "B1-B02",
    newSlot: "B1-B04",
    reason: "Slot B1-B02 đã bị chiếm",
  ...
  {
    id: "LOG-003",
    eventType: "Alternative Slot Accepted",
    performedBy: "user01",
    time: "2026-06-13 09:05",
    vehicle: "51B-67890",
    oldSlot: "B1-B02",
    newSlot: "B1-B04",
    reason: "User chấp nhận slot thay thế",
    reservationId: "RES-004",
    requestId: "",
    detail: "",
  },
  {
    id: "LOG-004",
    eventType: "Force Check-out",
    performedBy: "staff01",
    time: "2026-06-12 21:00",
    vehicle: "51C-11111",
    oldSlot: "B2-A02",
    newSlot: "",
    reason: "Hết giờ, xe chưa ra",
    reservationId: "",
    requestId: "",
    detail: "Force checkout bởi staff",
  },
  {
    id: "LOG-005",
    eventType: "Slot Disabled",
    performedBy: "admin",
    ...
    reservationId: "",
    requestId: "",
    detail: "Slot B1-A05 vô hiệu hóa",
  },
  {
    id: "LOG-006",
    eventType: "Slot Enabled",
    performedBy: "admin",
    time: "2026-06-11 08:00",
    vehicle: "",
    oldSlot: "B1-A05",
    newSlot: "",
    reason: "Bảo trì hoàn tất",
    reservationId: "",
    requestId: "",
    detail: "Slot B1-A05 kích hoạt lại",
  },
  {
    id: "LOG-007",
    ...
    oldSlot: "B2-B01",
    newSlot: "",
    reason: "No-show 2 giờ sau giờ đến",
    reservationId: "RES-006",
    requestId: "",
    detail: "Tự động hủy bởi hệ thống",
  },
  {
    id: "LOG-008",
    eventType: "Privilege Locked",
    performedBy: "system",
    time: "2026-06-11 12:00",
    vehicle: "51A-12345",
    oldSlot: "",
    newSlot: "",
    reason: "Đủ 3 no-show trong 30 ngày",
    reservationId: "",
    requestId: "",
    detail: "Khóa 7 ngày",
  },
  {
    ...
    reservationId: "",
    requestId: "",
    detail: "Đặt lại no-show counter",
  },
  {
    id: "LOG-010",
    ...
    oldSlot: "",
    newSlot: "",
    reason: "Admin khởi tạo hoàn tiền",
    reservationId: "",
    requestId: "REQ-007",
    detail: "Refund Pending → Refunded",
  },
];
...
export default function AdminAuditLog() {
  ...
  const filtered = SAMPLE.filter((l) => {
    ...
    if (
      filterPerformer &&
      !l.performedBy.toLowerCase().includes(filterPerformer.toLowerCase())
    )
      return false;
    if (
      filterVehicle &&
      !l.vehicle.toLowerCase().includes(filterVehicle.toLowerCase())
    )
      return false;
    if (
      filterSlot &&
      !l.oldSlot.includes(filterSlot) &&
      !l.newSlot.includes(filterSlot)
    )
      return false;
            ...
            <tbody>
              {filtered.map((l, i) => (
                ...
                >
                  ...
                  <td className={cls.td}>
                    <span
                      className={eventBadgeColor[l.eventType] ?? cls.badge.gray}
                    >
                      {l.eventType}
                    </span>
                  </td>
                  ...
                  <td className={cls.td}>
                    <span
                      className="text-xs text-gray-600 max-w-[120px] block truncate"
                      title={l.reason}
                    >
                      {l.reason || "—"}
                    </span>
