...
export function Pagination({
  ...
  const btn =
    "px-3 h-7 border border-gray-300 text-xs rounded hover:bg-gray-50 text-gray-600 cursor-pointer";
  const activebtn =
    "px-3 h-7 border border-blue-600 bg-blue-600 text-white text-xs rounded cursor-pointer";
  return (
